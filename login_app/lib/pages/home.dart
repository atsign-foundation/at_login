import 'dart:async';
// import 'package:app/domain/shared_data.dart';
// import 'package:app/services/at_common_service.dart';
import 'package:app/services/at_error_dialog.dart';
// import 'package:app/services/at_me_service.dart';
import 'package:app/services/navigator_service.dart';
import 'package:app/services/notification_service.dart';
import 'package:app/services/onboarding_widget_service.dart';
import 'package:app/utils/app_constants.dart';
import 'package:app/utils/strings.dart';
// import 'package:app/widgets/dashboard_widget.dart';
// import 'package:app/widgets/third_widget.dart';
import 'package:at_utils/at_logger.dart';
import 'package:flutter/material.dart';
import 'package:flutter/services.dart';
// import 'package:app/services/at_services.dart';
import 'package:receive_sharing_intent/receive_sharing_intent.dart';
import 'package:app/services/globals.dart' as globals;
...
class _HomeWidgetState extends State<HomeWidget> {
  ...
  Widget build(BuildContext context) {
    ...
    waviTextwidth = MediaQuery.of(context).size.width * 0.55;
    return Scaffold(
        ...
        child: AnnotatedRegion<SystemUiOverlayStyle>(
          ...
          child: Stack(
            children: [
              Positioned.fill(
                child: AtBubble(
                  callback: (StreamSubscription value) {
                    accel = value;
                  },
                ),
              ),
                                    ...
                                    children: [
                                      Positioned.fill(
                                        ...
                                        child: Image.asset(
                                          ...
                                          height: 100,
                                          // width: waviTextwidth / 2,
                                          fit: BoxFit.fill,
                                          alignment: Alignment.center,
                                        ),
                                      ),
                                      Positioned(
                                        right: waviTextwidth * 0.13,
                                        bottom: waviTextwidth * 0.02,
  ...
  _onboard(clientServiceMap, atsign) async {
    ...
    await AtMeService.getInstance().startMonitor();
    accel.cancel();
